...
- Storing page-specific data in session
- Accessing and modifying shared singleton
"""
...
def Page1(page: ft.Page):
    ...
    if not page.session.get("page1_data"):
        page.session.set("page1_data", {
            "visit_count": 0,
            "user_input": "",
            "last_updated": None
        })
    ...
    page1_data = page.session.get("page1_data")
    page1_data["visit_count"] += 1
    page.session.set("page1_data", page1_data)
    ...
    subtitle = ft.Text(
        "Demonstrates session data and shared object usage",
        size=16,
                    ...
                    [
                        ...
                        ft.Card(
                            content=ft.Container(
                                content=ft.Column([
                                    ft.Text("Session Data", size=16, weight=ft.FontWeight.BOLD),
                                    data_display
                                ], spacing=10),
                                padding=20
                            ),
